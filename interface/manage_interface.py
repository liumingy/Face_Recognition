...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("face.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionRegister.setIcon(icon1)
        self.actionRegister.setObjectName("actionRegister")
        self.actionCount = QtWidgets.QAction(MainWindow)
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("list.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionCount.setIcon(icon2)
        self.actionCount.setObjectName("actionCount")
        self.actionHistory = QtWidgets.QAction(MainWindow)
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("history.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap("people.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
